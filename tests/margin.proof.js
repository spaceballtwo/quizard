...
const scenarios = [
  ['Solo $79.99 — honest max',        chatCost('solo',DAYS)+repMax,          79.99,  false],
  ['Solo $79.99 — FRAUD spoofed unl', chatCost('unlimited',DAYS)+repMaxUnl,  75,  true],
  ['Unlimited $99.99 — max',         chatCost('unlimited',DAYS)+repMaxUnl,  99.99, false],
  ['Family $349.99 — 6 honest max',   famChatCost(6,'solo',DAYS)+6*repMax,   349.99, false],
