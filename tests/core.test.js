...
T('curve: 90% is low 700s not 770', (function(){const s=scaledCurve(22.5,25); return s>=715&&s<=740;})());
T('pctile anchors', pctileFor(500)===1 && pctileFor(650)===55 && pctileFor(800)===99);
T('pctile clamps', pctileFor(400)===1 && pctileFor(900)===99);
T('ordinal', ordinal(1)==='1st' && ordinal(2)==='2nd' && ordinal(11)==='11th' && ordinal(55)==='55th' && ordinal(92)==='92nd');
...
// composite math: perfect everything = 2400 (800 stays reachable, but the curve is steep near the top)
